...
1. The system SHALL render a home em `/` com as seções hero, "O que faz uma AT", "Pedagogia", "Sobre", "Formação", "Publicações", contato e rodapé, nesta ordem.
...
| SIT-07 | P1: Visitante entende a AT | T57,T58,T59 | Pending |
