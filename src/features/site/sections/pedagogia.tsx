      ...
      <Container>
        ...
        <ol className="mt-11 grid gap-9 cartao:grid-cols-2 grade:grid-cols-4 grade:gap-0">
          {secaoPedagogia.frentes.map((frente, indice) => (
            <li
              key={frente.titulo}
              // O escalonamento vem do trecho de rolagem, não de `animation-delay`:
              // numa timeline de progresso o atraso em tempo é ignorado. Cada
              ...
              className="frente-da-trilha relative grade:pr-6 grade:not-last:after:absolute grade:not-last:after:top-[calc(var(--spacing)*4.75)] grade:not-last:after:right-0 grade:not-last:after:left-9.5 grade:not-last:after:h-px grade:not-last:after:bg-line grade:not-last:after:content-['']"
            >
